...
$selectDataResult = $categoryObject->selectData();
                                ...
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">Categories</a>
                                        <ul class="mega-menu">
                                            <?php
                                            if ($selectDataResult) {
                                                $categories = $selectDataResult->fetch_all(MYSQLI_ASSOC);
                            ...
                            if (isset($_SESSION['user'])) { ?>
                                ...
                                <div class="dollar-submenu">
                                    <ul>
                                        ...
                                        <li><a href="../Routes/web.php?logout=true">Logout</a></li>
                                    </ul>
                                </div>
                            <?php } else { ?>
                                ...
                                <div class="dollar-submenu">
                                    <ul>
                                        <li><a href="../Routes/web.php?register=true">Register</a></li>
                                        <li><a href="../Routes/web.php?login=true">Login</a></li>
                                    </ul>
                                </div>
                            <?php } ?>
